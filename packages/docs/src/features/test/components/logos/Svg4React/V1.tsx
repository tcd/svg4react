    ...
    return (
        <Svg size="300px" vb={[300]}>
            ...
            <G strokeWidth="38.0086" stroke={color3}>
                <G id="v1-b" transform="translate(150, 150)">
                    <Path {...pathsProps.a} />                   {/* black line  9:00 to 3:00 */}
                    <use href="#v1-a" transform="rotate(45)"  /> {/* black line 10:00 to 4:00 */}
                    <use href="#v1-a" transform="rotate(90)"  /> {/* black line 12:00 to 6:00 */}
                    <use href="#v1-a" transform="rotate(135)" /> {/* black line  2:00 to 8:00 */}
                </G>
            </G>
